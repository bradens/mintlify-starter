...
getDetailedPairStats(pairAddress: String!, networkId: Int!, tokenOfInterest: TokenOfInterest, timestamp: Int, durations: [DetailedPairStatsDuration], bucketCount: Int, statsType: TokenPairStatisticsType): DetailedPairStats
```
