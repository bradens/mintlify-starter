...
For example, to get a list of swaps for the WBNB token on the BNB chain (networkId 56), you can use the following query:
...
Now you know how to use a paginated cursor to fetch more results. This pattern is used in many places in the Codex API.
