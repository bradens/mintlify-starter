...
keywords: ['filterNftParallelAssets']
---
...
<a href="/api-reference/types/parallelassetfilters">
...
<a href="/api-reference/types/parallelassetmatchers">
  <ResponseField name="match" type="ParallelAssetMatchers">
    A set of parameters to match.
  </ResponseField>
</a>

<a href="/api-reference/types/parallelassetranking">
